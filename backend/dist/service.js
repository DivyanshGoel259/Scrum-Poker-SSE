...
const _1 = require(".");
const joinGame = (_a) => __awaiter(void 0, [_a], void 0, function* ({ message, res, client }) {
    try {
...
const voted = (_a) => __awaiter(void 0, [_a], void 0, function* ({ message, res, client }) {
    try {
        const gameId = message.gameId;
        const gameString = yield (client === null || client === void 0 ? void 0 : client.get(`gameId:${gameId}`));
...
exports.voted = voted;
const reveal = (_a) => __awaiter(void 0, [_a], void 0, function* ({ message, res, client }) {
    try {
        const gameId = message.gameId;
        const gameString = yield (client === null || client === void 0 ? void 0 : client.get(`gameId:${gameId}`));
        const game = gameString ? JSON.parse(gameString) : null;
...
const reset = (_a) => __awaiter(void 0, [_a], void 0, function* ({ message, res, client }) {
    try {
        const gameId = message.gameId;
        const gameString = yield (client === null || client === void 0 ? void 0 : client.get(`gameId:${gameId}`));
        const game = gameString ? JSON.parse(gameString) : null;
